  ...
  <div class="h-screen flex overflow-hidden bg-gray-100">
    ...
    <div v-show="menu" class="md:hidden">
      ...
      -->
        ...
        >
          <div v-show="menu" class="fixed inset-0" aria-hidden="true">
          ...
          >
            ...
            <div class="mt-5 flex-1 h-0 overflow-y-auto">
              <nav class="px-2 space-y-1">
                <a
                  href="#"
                  class="group flex items-center px-2 py-2 text-base font-medium rounded-md text-white bg-gray-900"
                >
                  <!-- Heroicon name: home -->
                  <svg
        ...
        <div class="flex flex-col h-0 flex-1">
          ...
          <div class="flex-1 flex flex-col overflow-y-auto">
            <nav class="flex-1 px-2 py-4 bg-gray-800 space-y-1">
              <a
                href="#"
                class="group flex items-center px-2 py-2 text-sm font-medium text-white rounded-md bg-gray-900"
              >
                <!-- Heroicon name: home -->
                <svg
