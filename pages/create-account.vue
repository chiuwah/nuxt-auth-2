  ...
  >
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <img
        ...
        src="https://www.1moda.nl/skin/frontend/ultimo/default/images/1moda.png"
        alt="Workflow"
      />
    ...
    <div
      v-if="errorMessage"
      class="mt-6 sm:mx-auto sm:w-full sm:max-w-md rounded-md bg-red-50 p-4"
    >
      <div class="flex">
      ...
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        ...
        >
          ...
          <div>
            ...
            >
              {{ $t("signup.create_account_button_text") }}
            </button>
          </div>
        </form>

        <form v-else @submit.prevent="confirm" class="space-y-6">
          <div>
            <label for="email" class="block text-sm font-medium text-gray-700">
              Email address
            </label>
